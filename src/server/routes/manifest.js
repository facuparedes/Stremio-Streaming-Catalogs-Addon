 ...
 */
function buildNetflixTop10Catalogs(
  netflixTop10Global,
  netflixTop10Country,
  ...
  const enableNetflixTop10Global =
    netflixTop10Global === undefined || netflixTop10Global === "1";
...
export function handleConfiguredManifest(req, res, mixpanel) {
  ...
  // New format: [token, selectedProviders, rpdbKey, countryCode, installedAt, netflixTop10Global, netflixTop10Country, netflixTop10CountryCode, language]
  const [
    token,
    selectedProviders,
    rpdbKey,
